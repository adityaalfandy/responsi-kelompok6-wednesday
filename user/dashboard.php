...
<head>
    ...
    <title>Dashboard - Wednesday Quiz</title>
    <style>
        /* --- LOAD FONTS --- */
        @font-face {
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-logo {
            font-family: 'MetalMania', cursive; font-size: 26px; color: white;
            letter-spacing: 2px;
        }
        ...
        .user-profile {
            ...
            background-color: #d4af37; padding: 5px 15px 5px 5px;
            border-radius: 30px; color: black; font-weight: bold;
            font-family: 'Risque', serif;
        }
        ...
        /* Styling Dropdown Box Sesuai Gambar */
        .dropdown-menu {
            display: none; /* Hidden by default */
            position: absolute;
            top: 50px; right: 0; /* Muncul di bawah profil */
            width: 250px;
            border-radius: 15px;
            overflow: hidden;
        ...
        /* Bagian Atas: Kuning (Foto & Nama Besar) */
        .dropdown-header {
            background-color: #d4af37; /* Kuning Emas */
            padding: 20px;
            text-align: center;
        ...
        /* Bagian Bawah: Coklat Gelap (Links) */
        .dropdown-body {
            background-color: #5d5318; /* Warna Zaitun/Coklat Gelap */
            padding: 15px 0;
        }
        ...
        /* --- STYLES CARD DASHBOARD (TETAP SAMA) --- */
        .game-card {
        ...
        .btn-gold:hover { background: rgba(196, 159, 39, 0.96); transform: scale(1.05); }
        .btn-music { width: 100px; }
...
<body>
    ...
    <div class="game-card">
        ...
        <div class="btn-group">
            <a href="confirmation.php" class="btn-gold">START</a>
            
            <button id="musicBtn" class="btn-gold btn-music" onclick="toggleMusic()">
                <svg id="musicIcon" class="svg-icon" viewBox="0 0 24 24">
    ...
    <script>
        ...
        var isPlaying = false; // Default mati
